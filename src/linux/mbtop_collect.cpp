...
//? Logs namespace stubs for Linux (Logs panel is macOS-only, uses unified logging)
namespace Logs {
	string box;
	...
	string custom_tag_color;
	string current_cmdline;
	...
	string pm_cmd_input;
	string pm_display_input;
	string pm_path_input;
	bool pm_tagged_input = false;
	int pm_color_input = 0;
	int pm_log_view_input = 0;
	bool pm_save_pending = false;
	bool pm_delete_pending = false;
